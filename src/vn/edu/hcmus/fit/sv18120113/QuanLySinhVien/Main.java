...
public class Main {
    public static void CSVReaderExample() {
        List<String[]> dsSinhVien = CSVUtil.reader("sinhVien_18HCB.csv");
    ...
    public static void importDanhSachLopExample() {
        List<String[]> danhSachLop = CSVUtil.reader("sinhVien_17HCB.csv");
    ...
    public static void importThoiKhoaBieuExample() {
        List<String[]> thoiKhoaBieu = CSVUtil.reader("thoiKhoaBieu_17HCB.csv");
    ...
    public static void importBangDiemExample() {
        List<String[]> bangDiem = CSVUtil.reader("bangDiem.csv");
